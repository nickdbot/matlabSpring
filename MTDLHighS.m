function output = MTDLHighS(input,spring)
    ...
    else inVal2 = spring.delayLHigh(spring.dlyLHighIndex+Ih+1,1);
    end
    
    output = frach*inVal + (1-frach)*inVal2; %linear interpolation equation
    spring.delayLHigh(spring.dlyLHighIndex,1) = input;
