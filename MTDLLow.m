function output = MTDLLow(input,spring) 
...
for i = 1:spring.BLOCK_SIZE
  ...
  output(i,1) = spring.gripple*tempVal + spring.delayLripple(spring.dlyLrippleIndex,1);
  ...
  %L0 = input
  spring.delayL0(spring.dlyL0Index,1) = input(i,1);
